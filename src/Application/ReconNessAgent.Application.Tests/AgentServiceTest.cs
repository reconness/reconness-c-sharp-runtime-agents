...
namespace ReconNessAgent.Application.Tests
{
    public class AgentServiceTest
    {
        ...
        public async Task Run_Skip_Target_ExcludeName_RegExp_Command_Async()
        {
            ...
            var agent = await CreateTestAgentAsync(script, "NAS {{target}}", "Target", new AgentTrigger { TargetIncExcName = "EXCLUDE", TargetName = ".*TargetName$" });
            var target = await CreateTestTargetAsync(agent.Name!);
        ...
        public async Task Run_Skip_Target_IncludeName_And_HasBounty_RegExp_Command_Async()
        {
            ...
            var agent = await CreateTestAgentAsync(script, "ASN {{target}}", "Target", new AgentTrigger { TargetHasBounty = true, TargetIncExcName = "INCLUDE", TargetName = ".*argetName$" });
            var target = await CreateTestTargetAsync(agent.Name!, true);
        ...
        public async Task Run_Skip_Rootdomain_ExcludeName_RegExp_Command_Async()
        {
            ...
            var agent = await CreateTestAgentAsync(script, "sublister {{rootdomain}}", "RootDomain", new AgentTrigger { RootdomainIncExcName = "EXCLUDE", RootdomainName = ".*otdomain.com$" });
            var target = await CreateTestTargetAsync();
            var rootDomain = await CreateTestRootDomainAsync(target, agent.Name!);
        ...
        public async Task Run_Skip_Rootdomain_IncludeName_And_HasBounty_RegExp_Command_Async()
        {
            ...
            var agent = await CreateTestAgentAsync(script, "sublister {{rootdomain}}", "RootDomain", new AgentTrigger { RootdomainIncExcName = "INCLUDE", RootdomainName = ".*rootdomain.com$", RootdomainHasBounty = true });
            var target = await CreateTestTargetAsync();
            var rootDomain = await CreateTestRootDomainAsync(target, agent.Name!, true);
        ...
        public async Task Run_Skip_Subdomain_ExcludeName_RegExp_Command_Async()
        {
            ...
            var agent = await CreateTestAgentAsync(script, "ping {{subdomain}}", "Subdomain", new AgentTrigger { RootdomainIncExcName = "EXCLUDE", RootdomainName = ".*myrootdomain.com$" });
            var target = await CreateTestTargetAsync();
            var rootDomain = await CreateTestRootDomainAsync(target);
            var subdomain = await CreateTestSubDomainAsync(rootDomain, agent.Name!);
        ...
        public async Task Run_Skip_Subdomain_IncludeName_And_HasBounty_RegExp_Command_Async()
        {
            ...
            var agent = await CreateTestAgentAsync(script, "ping {{subdomain}}", "Subdomain", new AgentTrigger { RootdomainIncExcName = "INCLUDE", RootdomainName = ".*myrootdomain.com$", SubdomainHasBounty = true });
            var target = await CreateTestTargetAsync();
            var rootDomain = await CreateTestRootDomainAsync(target);
            var subdomain = await CreateTestSubDomainAsync(rootDomain, agent.Name!, true);
