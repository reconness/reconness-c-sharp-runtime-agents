...
/// <summary>
/// This class implement the interface <see cref="IDbContext"/> and EF Core <see cref="DbContext"/>.
/// </summary>
public partial class ReconnessDbContext : DbContext, IDbContext
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ReconnessDbContext" /> class.
    /// </summary>
    /// <param name="options">The <see cref="DbContextOptions{ReconnessDbContext}"/> options with the connectionstring inside.</param>
    ...
    /// <summary>
    /// This method was generated by the database first tool.
    /// We did a couple of changes to allow generete automatic some GUID for some entities.
    /// </summary>
